...
Send Tx XCP variables and validating on CAN signals for message mWhdCtrl2
    ...
    Write Multiple XCP Variables    ${xcp_var_map}    ${xcp_values}
    ${expected_can_signals}=    Evaluate    {"VoltLmtMax":0,"VoltLmtMin":0,"CurrLmtMtr":0,"CurrLmtRegen":0,"TrqLmtMtr":0,"TrqLmtRegen":0,"WhdShtdwnRq":"False","ClearFltRq":"False","MsgCntr":0,"MsgCrc":0}
    ...
    Write Multiple XCP Variables    ${xcp_var_map}    ${xcp_values}
    ${expected_can_signals}=    Evaluate    {"VoltLmtMax":47.75,"VoltLmtMin":47.75,"CurrLmtMtr":63,"CurrLmtRegen":63,"TrqLmtMtr":127,"TrqLmtRegen":127,"WhdShtdwnRq":"False","ClearFltRq":"False","MsgCntr":7,"MsgCrc":127}
    Run Keyword And Continue On Failure    Validate Tx Message With Expected Values    mWhdCtrl2    ${expected_can_signals}    30
...
Send Tx XCP variables and validating on CAN signals for message mVehState3
    ...
    Write Multiple XCP Variables    ${xcp_var_map}    ${xcp_values}
    ${expected_can_signals}=    Evaluate    {"ArbVehSpd_mps_Valid":"Invalid","ArbVehSpd_mps":-20.48,"ROI":-1.28,"TargetVehSpd_mps":-20.48,"Aeb_Active":"No_AEB_event_active","AebSrc":"No_AEB_event","MsgCntr":0,"MsgCrc":0}
    ...
    Write Multiple XCP Variables    ${xcp_var_map}    ${xcp_values}
    ${expected_can_signals}=    Evaluate    {"ArbVehSpd_mps_Valid":"Invalid","ArbVehSpd_mps":-0.005,"ROI":-0.005,"TargetVehSpd_mps":-0.005,"Aeb_Active":"No_AEB_event_active","AebSrc":"No_AEB_event","MsgCntr":0,"MsgCrc":0}
    Run Keyword And Continue On Failure    Validate Tx Message With Expected Values    mVehState3    ${expected_can_signals}    30

    Log    writing max value to the xcp variables
    ${xcp_values}=    Evaluate    {"ArbVehSpd_mps_Valid":"valid","ArbVehSpd_mps":20.47,"ROI":1.27,"TargetVehSpd_mps":20.47,"Aeb_Active":0,"AebSrc":15,"MsgCntr":15,"MsgCrc":255}
    Write Multiple XCP Variables    ${xcp_var_map}    ${xcp_values}
    ${expected_can_signals}=    Evaluate    {"ArbVehSpd_mps_Valid":0,"ArbVehSpd_mps":20.47,"ROI":1.27,"TargetVehSpd_mps":20.47,"Aeb_Active":"No_AEB_event_active","AebSrc":"FCM_Thermal_LIDAR_LRR","MsgCntr":15,"MsgCrc":255}
    Run Keyword And Continue On Failure    Validate Tx Message With Expected Values    mVehState3    ${expected_can_signals}    30
...
Send Tx XCP variables and validating on CAN signals for message mVehState
    ...
    Log    writing min value to the xcp variables
    ${xcp_values}=    Evaluate    {"VehState":0,"VcuEstopSns":0,"CrashSns":0,"VehDte":0,"LvVolt":0,"GearRq":0,"GearAct":0,"SBW_RtEndStopReached":0,"SBW_LfEndStopReached":0,"GearChangeParkAllow":0,"GearChangeDrvRevAllow":0,"ArbVehSpdValid":0,"EstopDetected":0,"VehParkRq":0,"Tether_Connected":0,"ArbVehSpd":2046,"MsgCntr":0,"TO_Allowed":0,"AD_Allowed":0,"LOS_Allowed":0,"Invld_GearRq":0,"MsgCrc":0}
    ...
    Write Multiple XCP Variables    ${xcp_var_map}    ${xcp_values}
    ${expected_can_signals}=    Evaluate    {"VehState":"NA","VcuEstopSns":"OK","CrashSns":"False","VehDte":0,"LvVolt":0,"GearRq":"Park","GearAct":"Park","SBW_RtEndStopReached":"False","SBW_LfEndStopReached":"False","GearChangeParkAllow":"Not_Allowed","GearChangeDrvRevAllow":"Not_Allowed","ArbVehSpdValid":"Invalid","EstopDetected":"ok","VehParkRq":"No_Request","Tether_Connected":"Disconnected","ArbVehSpd":"Fault","MsgCntr":0,"TO_Allowed":"Not_Allowed","AD_Allowed":"Not_Allowed","LOS_Allowed":"Not_Allowed","Invld_GearRq":0,"MsgCrc":0}
    ...
    Log    writing max value to the xcp variables
    ${xcp_values}=    Evaluate    {"VehState":15,"VcuEstopSns":1,"CrashSns":1,"VehDte":102.3,"LvVolt":25.5,"GearRq":3,"GearAct":3,"SBW_RtEndStopReached":1,"SBW_LfEndStopReached":1,"GearChangeParkAllow":0,"GearChangeDrvRevAllow":0,"ArbVehSpdValid":0,"EstopDetected":1,"VehParkRq":0,"Tether_Connected":0,"ArbVehSpd":2047,"MsgCntr":15,"TO_Allowed":0,"AD_Allowed":0,"LOS_Allowed":0,"Invld_GearRq":1,"MsgCrc":255}
    Write Multiple XCP Variables    ${xcp_var_map}    ${xcp_values}
    ${expected_can_signals}=    Evaluate    {"VehState":"sleep","VcuEstopSns":"Estop","CrashSns":"TRUE","VehDte":102.3,"LvVolt":25.5,"GearRq":"Fwd","GearAct":"Fwd","SBW_RtEndStopReached":"TRUE","SBW_LfEndStopReached":"TRUE","GearChangeParkAllow":"Not_Allowed","GearChangeDrvRevAllow":"Not_Allowed","ArbVehSpdValid":"Invalid","EstopDetected":"Estop","VehParkRq":"Park_request","Tether_Connected":0,"ArbVehSpd":"SNA","MsgCntr":15,"TO_Allowed":"Not_Allowed","AD_Allowed":"Not_Allowed","LOS_Allowed":"Not_Allowed","Invld_GearRq":1,"MsgCrc":255}
    Run Keyword And Continue On Failure    Validate Tx Message With Expected Values    mVehState    ${expected_can_signals}    30
...
Send Tx XCP variables and validating on CAN signals for message mWhdCtrl
    ...
    Write Multiple XCP Variables    ${xcp_var_map}    ${xcp_values}
    ${expected_can_signals}=    Evaluate    {"TrqSlewLmt":0,"SpdSlewLmt":0,"CtrlMode":"Disable","MtrMode":"NORMAL","EnblCmd":"False","Boot":"Normal","Debug":0,"TrqCmd":-1023,"SpdCmd":-1023,"MsgCntr":0,"MsgCrc":0}
    ...
    Write Multiple XCP Variables    ${xcp_var_map}    ${xcp_values}
    ${expected_can_signals}=    Evaluate    {"TrqSlewLmt":25.4,"SpdSlewLmt":2.54,"CtrlMode":"Disable","MtrMode":7,"EnblCmd":"TRUE","Boot":1,"Debug":"DEBUG","TrqCmd":1024,"SpdCmd":1024,"MsgCntr":15,"MsgCrc":255}
    Run Keyword And Continue On Failure    Validate Tx Message With Expected Values    mWhdCtrl    ${expected_can_signals}    30