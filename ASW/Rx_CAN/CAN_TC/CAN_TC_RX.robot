...
*** Test Cases ***
TC-RX-mTCRightJoyStat: Send mTCRightJoyStat with Signal Values and Verify by reading XCP Variable
...
TC-RX-mTCLeftJoyStat: Send mTCLeftJoyStat with Signal Values and Verify by reading XCP Variable
...
TC-RX-mTcSwVer: Send mTcSwVer with Signal Values and Verify by reading XCP Variable
    [Documentation]    Validate RX message mCgmFaults and XCP variable read
    Log    Assigning Minimum Value to the signal
