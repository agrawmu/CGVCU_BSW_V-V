...
*** Test Cases ***
VM-RX-AUXIO1_BMS2: Send AUXIO1_BMS2 with Signal Values and Verify by reading XCP Variable
...
VM-RX-HVESSS2_BMS2: Send HVESSS2_BMS2 with Signal Values and Verify by reading XCP Variable
    [Documentation]    Validate RX message handling and XCP variable read
...
VM-RX-mSbwFaults: Send mSbwFaults with Signal Values and Verify by reading XCP Variable
    [Documentation]    Validate RX message handling and XCP variable read
...
VM-RX-HVESSD1_BMS2: Send HVESSD1_BMS2 with Signal Values and Verify by reading XCP Variable
...
VM-RX-HVESSD10_BMS2: Send HVESSD10_BMS2 with Signal Values and Verify by reading XCP Variable
...
VM-RX-HVESSD3_BMS2: Send HVESSD3_BMS2 with Signal Values and Verify by reading XCP Variable
...
VM-RX-HVESSD4_BMS2: Send HVESSD4_BMS2 with Signal Values and Verify by reading XCP Variable
...
VM-RX-HVESSD5_BMS2: Send HVESSD5_BMS2 with Signal Values and Verify by reading XCP Variable
...
VM-RX-HVESSD2_BMS2: Send HVESSD2_BMS2 with Signal Values and Verify by reading XCP Variable
...
VM-RX-mWhdWarn: Send mWhdWarn with Signal Values and Verify by reading XCP Variable
...
VM-RX-mWhdStat3: Send mWhdStat3 with Signal Values and Verify by reading XCP Variable
...
VM-RX-mLeftJoyStat: Send mLeftJoyStat with Signal Values and Verify by reading XCP Variable
...
VM-RX-mEbcm2L_BrkTrqEst: Send mEbcm2L_BrkTrqEst with Signal Values and Verify by reading XCP Variable
...
VM-RX-mEbcm2L_BrkPress2: Send mEbcm2L_BrkPress2 with Signal Values and Verify by reading XCP Variable
...
VM-RX-mAVAS_Stat: Send mAVAS_Stat with Signal Values and Verify by reading XCP Variable
...
VM-RX-HVESSS1_BMS2: Send HVESSS1_BMS2 with Signal Values and Verify by reading XCP Variable
...
VM-RX-mEpb_EpbStat: Send mEpb_EpbStat with Signal Values and Verify by reading XCP Variable
...
VM-RX-HVESSD6_BMS2: Send CAN signal values and validate them by reading HVESSD6_BMS2 through XCP value
    [Documentation]    Validate RX message handling and XCP variable read
...
VM-RX-HVESSD7_BMS2: Send CAN signal values and validate them by reading HVESSD7_BMS2 through XCP value
    [Documentation]    Validate RX message handling and XCP variable read
...
VM-RX-mEbcm1U_SwVer: Send CAN signal values and validate them by reading mEbcm1U_SwVer through XCP value
    [Documentation]    Validate RX message handling and XCP variable read
...
VM-RX-mEbcm2L_BrkPress: Send CAN signal values and validate them by reading mEbcm2L_BrkPress through XCP value
    [Documentation]    Validate RX message handling and XCP variable read
...
VM-RX-mEbcm2L_WhlCnt: Send CAN signal values and validate them by reading mEbcm2L_WhlCnt through XCP value
    [Documentation]    Validate RX message handling and XCP variable read
...
VM-RX-mEbcm2L_WhlSlip: Send CAN signal values and validate them by reading mEbcm2L_WhlSlip through XCP value
    [Documentation]    Validate RX message handling and XCP variable read
...
VM-RX-STATUS_BMS2: Send CAN signal values and validate them by reading STATUS_BMS2 through XCP value
    [Documentation]    Validate RX message handling and XCP variable read
...
VM-RX-VEP2_BMS2: Send CAN signal values and validate them by reading VEP2_BMS2 through XCP value
    [Documentation]    Validate RX message handling and XCP variable read
...
VM-RX-HVESSD8_BMS2: Send CAN signal values and validate them by reading HVESSD8_BMS2 through XCP value
    [Documentation]    Validate RX message handling and XCP variable read
...
VM-RX-HVESSD9_BMS2: Send CAN signal values and validate them by reading HVESSD9_BMS2 through XCP value
    [Documentation]    Validate RX message handling and XCP variable read
    Log    Assigning Minimum Value to the signal
...
VM-RX-mCurrAvailPeak_BMS2: Send mCurrAvailPeak_BMS2 with Signal Values and Verify by reading XCP Variable
...
VM-RX-mEbcm2L_EpbStat: Send mEbcm2L_EpbStat with Signal Values and Verify by reading XCP Variable
...
VM-RX-mLeftJoyStat2: Send mLeftJoyStat2 with Signal Values and Verify by reading XCP Variable
...
VM-RX-mSbwPosition: Send mSbwPosition with Signal Values and Verify by reading XCP Variable
...
VM-RX-mSbwStat: Send mSbwStat with Signal Values and Verify by reading XCP Variable
...
VM-RX-mWhdStat2: Send mWhdStat2 with Signal Values and Verify by reading XCP Variable
...
VM-RX-mWhdFaults: Send mWhdFaults with Signal Values and Verify by reading XCP Variable
...
VM-RX-mEbcm1U_BrkPress2: Send mEbcm1U_BrkPress2 with Signal Values and Verify by reading XCP Variable
...
VM-RX-mRightJoyStat: Send mRightJoyStat with Signal Values and Verify by reading XCP Variable
...
VM-RX-mEbcm2L_Stat: Send mEbcm2L_Stat with Signal Values and Verify by reading XCP Variable
...
VM-RX-mEbcm1U_Stat2: Send mEbcm1U_Stat2 with Signal Values and Verify by reading XCP Variable
...
VM-RX-mEbcm2L_TrqLmts: Send mEbcm2L_TrqLmts with Signal Values and Verify by reading XCP Variable
...
VM-RX-mSbwSys_Allied: Send mSbwSys_Allied with Signal Values and Verify by reading XCP Variable
...
VM-RX-mVscStat: Send mVscStat with Signal Values and Verify by reading XCP Variable
...
VM-RX-mWhdStat: Send mWhdStat with Signal Values and Verify by reading XCP Variable
...
VM-RX-mSbwStat2with: Send mSbwStat2with Signal Values and Verify by reading XCP Variable
...
VM-RX-mSbwStat_Allied: Send mSbwStat_Allied with Signal Values and Verify by reading XCP Variable
...
VM-RX-mEbcm2L_SwVer: Send mEbcm2L_SwVer with Signal Values and Verify by reading XCP Variable
...
VM-RX-mEbcm1U_Stat: Send mEbcm1U_Stat with Signal Values and Verify by reading XCP Variable
...
VM-RX-mRightJoyStat2: Send mRightJoyStat2 with Signal Values and Verify by reading XCP Variable
