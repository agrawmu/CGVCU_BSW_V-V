...
import pycanape
import pyautogui
import logging  # <-- Added to suppress internal log output
 
# Suppress pycanape internal warnings (CANapAPI missing functions etc.)
    ...
    if module is None or canape_instance is None:
        try:
            canape_instance = pycanape.CANape(
                project_path=r"D:\Jenkins\workspace\CGVCU_BSW_Mcore\IMU\IMU_Configuration\IMU",
                modal_mode=True,
            )
